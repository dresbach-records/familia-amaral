        ...
        <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden bg-primary shadow-2xl py-20">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center gap-6 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-500">
              <Link href="/cadastro">
                <Button size="lg" className="bg-accent hover:bg-accent/90 text-white border-none px-10 py-8 text-lg md:text-xl font-bold uppercase tracking-[0.2em] shadow-lg shadow-black/20 rounded-full transition-all hover:scale-105">
                  Unir-se à Linhagem
                </Button>
              </Link>
              <Link href="/origem">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                <Card key={i} className="bg-white border-none shadow-xl hover:-translate-y-2 transition-transform duration-300 overflow-hidden rounded-[2.5rem]">
