          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto space-y-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card className="border-l-4 border-l-accent shadow-lg bg-white rounded-[2rem]">
                  <CardHeader>
              ...
              <div className="relative border-l-2 border-accent/30 pl-8 ml-4 md:ml-0 space-y-12">
                {timelineEvents.map((event, index) => (
                  <div key={index} className="relative">
                    ...
                    <div className="bg-white p-8 rounded-[2rem] shadow-xl border border-muted hover:border-accent/50 transition-colors">
              ...
              {/* Final Conclusion */}
              <div className="bg-primary text-white p-12 rounded-[3rem] shadow-2xl relative overflow-hidden text-center border-t-8 border-accent">
