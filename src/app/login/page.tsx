  ...
  return (
    <div className="min-h-screen bg-muted/20 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="mb-12 text-center animate-in fade-in zoom-in duration-1000">
        ...
        <h1 className="text-4xl font-headline font-bold text-primary tracking-widest uppercase">Portal de Membros</h1>
        <div className="w-16 h-0.5 bg-accent mx-auto mt-4"></div>
      </div>
      
      <Card className="w-full max-w-md border-2 border-accent/20 shadow-2xl rounded-[2.5rem] bg-white overflow-hidden relative z-10">
        <div className="absolute top-0 right-0 p-4 opacity-10">
          <ShieldAlert className="w-12 h-12 text-primary" />
        </div>
        <CardHeader className="text-center pt-10 pb-6">
          <CardTitle className="font-headline text-2xl text-primary">Acesso Restrito</CardTitle>
          <CardDescription className="italic font-body">Identifique-se para visualizar a árvore genealógica.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6 p-10">
          <div className="space-y-3">
            ...
            <Input 
              ...
              className="bg-muted/40 border-primary/5 focus:border-accent py-6 rounded-xl" 
            />
          </div>
          <div className="space-y-3">
            <label className="text-[10px] font-bold text-primary uppercase tracking-[0.2em] flex items-center gap-2">
          ...
          <Button className="w-full bg-primary hover:bg-primary/95 py-8 font-bold text-lg uppercase tracking-widest rounded-full shadow-lg transition-transform hover:scale-[1.02]">
            Entrar no Portal
          </Button>
          
          <div className="text-center pt-4 border-t border-muted mt-6">
            <p className="text-sm text-muted-foreground font-body">
              Não faz parte da linhagem oficial?{' '}
      ...
      <footer className="mt-12 text-[9px] text-muted-foreground uppercase tracking-[0.4em] text-center max-w-xs font-bold bg-white/50 backdrop-blur-sm px-4 py-2 rounded-full border border-primary/5">
        Ambiente Seguro para Descendentes Verificados
      </footer>
    </div>
  );
}
