...
import { Shield, Users, Crown, Landmark } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8f6f0] pb-24">
      ...
      <section className="bg-primary pt-24 pb-32 text-center border-b-[6px] border-accent relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-accent italic font-headline text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed">
      ...
      <section className="py-16 -mt-16 relative z-20">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-[3rem] shadow-[0_30px_100px_rgba(0,0,0,0.12)] border-2 border-accent/10 overflow-hidden">
